...
%   .history      struct array per generation
    ...
    % ---- physical bounds ----
    lb = [4.0;  0.30;  0.0; -5.0; 20.0; 0.030; 1.00; 0.30; 20.0; 20.0; 0.001];
    ub = [10.0; 0.80; 30.0;  3.0; 90.0; 0.150; 2.50; 0.70; 50.0; 28.0; 0.006];
    x0_def = [8.5; 0.702; 22.7; 0.0; 40.0; 0.0657; 2.41; 0.400; 40.7; 24.0; 0.0029];
